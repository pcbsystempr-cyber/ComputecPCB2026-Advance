-- ============================================
-- COMPUTEC: analitica de visitas al sitio publico
-- Archivo alterno solicitado: page_analytic.sql
...
drop policy if exists anon_read_daily_visit_stats on public.page_stats_daily;
